    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 bg-card">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto opacity-0 animate-fade-up" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
            Reserve your spot for an unforgettable dining experience at Cozmo Cafe Bistro Lounge.
          </p>
        </div>
      </section>
      ...
      <Section>
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            <h2 className="font-display text-3xl text-foreground mb-6">Make a Reservation</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-4 bg-card border border-border rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">123 Luxury Boulevard, Downtown District, City 12345</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Section dark>
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display text-2xl text-foreground mb-6">Reservation Policy</h2>
