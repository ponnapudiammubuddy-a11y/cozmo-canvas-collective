          ...
          <div className="hidden lg:flex items-center gap-1">
            {navigationItems.map((item) => (
              ...
              >
                <Link
                  to={item.href}
                  className={`flex items-center gap-1 px-4 py-2 text-sm font-medium transition-all duration-300 relative group ${
                    activeDropdown === item.name ? 'text-primary' : 'text-foreground/80 hover:text-primary'
                  }`}
                >
                  {item.name}
                  {item.subItems && (
                  ...
                  <span className={`absolute bottom-0 left-4 right-4 h-[2px] bg-primary transform origin-left transition-transform duration-300 ${
                ...
                {item.subItems && activeDropdown === item.name && (
                  ...
                  >
                    <div className="bg-card/98 backdrop-blur-xl border border-border/60 rounded-xl shadow-2xl overflow-hidden min-w-[220px]"
                      style={{ 
